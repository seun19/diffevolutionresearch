...
namespace CSC899.Forms_DE_Best
{
    public partial class AckleyForm : Form
    {
        ...
        public void TestAckley()
        {
            ...
            Vector[] mutantVectors;  //mutant vectors
            Vector[] trialVectors;  // trial vectors for next generation based on fitness
            ...
            while (runs <= numberOfRuns)
            {
                ...
                for (int i = 0; i < iterations; i++)
                {
                    ...
                    trialVectorFitness = Addons.CalculateFitness(trialVectors, "Ackley");
                    // Print fitness
