...
namespace CSC899.Forms_DE_Rand_SA
{
    public partial class RosenbrockForm : Form
    {
        ...
        ThreadStart testRosenbrockRef;
        Thread testRosenbrockThread;

        public RosenbrockForm()
        {
            InitializeComponent();
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            testRosenbrockRef = new ThreadStart(TestRosenbrock);
            testRosenbrockThread = new Thread(testRosenbrockRef);
            testRosenbrockThread.Start();
        }

        private void btnPause_Click(object sender, EventArgs e)
        {
            //Pause the optimization thread
            testRosenbrockThread.Suspend();
        }

        private void btnResume_Click(object sender, EventArgs e)
        {
            //Resume the optimization thread
            testRosenbrockThread.Resume();
        }

        private void btnAbort_Click(object sender, EventArgs e)
        {
            //Abort the optimization thread
            testRosenbrockThread.Abort();
        }
